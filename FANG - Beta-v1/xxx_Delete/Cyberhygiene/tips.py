...
def tips_py():
    ...
    print("Maintain good password hygiene.\nUpdate systems and software.\n")

    print("Multi Factor Authentication\n")

    print("Keep up-to-date on phishing/security training and awareness\n")

    print("Implement 'Zero Trust'\n\n\n")
...
def tips_lit():
    ...
    if select == "Maintain good password hygiene":
        ...
        lit.subheader("Some reason why you should")
        lit.markdown("- Reduce the chancesof data breach")
        ...
        lit.write("MFA provides more then one way to verify your login, hackersa are unable to access your accounts without knowing all three keys at the time you log in")
        ...
        lit.subheader("Some reason why you should")
        lit.write("Detect and remove computer Virus andanti-malware from your device")
        lit.markdown("- Malware & Virus Protection")
        lit.markdown("- Defense Against Data Thieves")
        lit.markdown("- Increases Your Computer’s Lifetime")
        lit.markdown("-C omprehensive Threat Protection")
        ...
        lit.write("Starting somewhere is better then nowhere")
